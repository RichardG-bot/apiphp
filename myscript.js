...
function load()
{
	...
	xhr.open("GET", 'http://localhost/apiphp/students.php', true);
    xhr.onload = function()
    {
...
function removeStudent(id, button)
{
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("DELETE", 'http://localhost/apiphp/students.php/' + id , true);
    xhr.onload = function()
    {
        if(xhr.status != 200)
        {
...
{
    var xhr = new XMLHttpRequest();
    xhr.open("PATCH", 'http://localhost/apiphp/students.php/' + id , true);
    xhr.onload = function()
    {
        if(xhr.status != 200)
        {
...
function addCorso()
{
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", 'http://localhost/apiphp/students.php' , true);
    xhr.onload = function()
    {
        if(xhr.status != 200)
        {
...
function newStudent()
{
    ...
    appTitle = document.getElementById("appTitle");
    var xhr = new XMLHttpRequest();
    xhr.open("GET", 'http://localhost/apiphp/classes.php' , true);
    xhr.onload = function()
    {
